<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\wamp64\www\app\public/../application/index\view\order\order.html";i:1529508252;}*/ ?>
﻿<!DOCTYPE html>
<html>
														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	...
																	<p class="order-info"><a href="<?php echo url('index/order/orderinfo'); ?>">订单详情</a></p>
																	<p class="order-info"><a href="<?php echo url('index/order/logistics'); ?>">查看物流</a></p>
																</div>
															</li>
												...
												<div class="order-content">
													...
													<div class="order-right">
														...
														<div class="move-right">
															...
															<li class="td td-change">
																<a href="<?php echo url('index/order/commentlist'); ?>">
																	<div class="am-btn am-btn-danger anniu">
																		评价商品</div>
																</a>
															</li>
