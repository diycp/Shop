<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\wamp64\www\app\public/../application/index\view\index\shopcart.html";i:1527000613;}*/ ?>
						...
						<div class="bundle  bundle-last ">
							...
							<div class="bundle-main">
								<ul class="item-content clearfix">
									...
									<li class="td td-item">
										<div class="item-pic">
											<a href="#" ><img src="/home/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
											<div class="item-basic-info">
												<a href="#"><?php echo $data['gname']; ?></a>
											</div>
										</div>
									</li>
									<li class="td td-info">
										...
										<div class="item-price price-promo-promo">
											<div class="price-content">
												<div class="price-line">
													...
													<?php echo $data['price']; ?></em>
													<input  name="price" hidden="hidden" value="<?php echo $data['price']; ?>">
												</div>
											</div>
										</div>
									</li>
										...
										<div class="amount-wrapper ">
											<div class="item-amount ">
												<div class="sl">
													...
													<input type="button" class=" am-btn" name="minus" value="-" onclick="minus(0);">
													<input type="text" class="text_box" name="amount" value="<?php echo $data['number']; ?>"  style="width:30px;">
													<input type="button" class=" am-btn" name="plus" value="+" onclick="plus(0);">
												</div>
											</div>
										</div>
									</li>
									<li class="td td-sum">
										<div class="td-inner">
											<em tabindex="0" class="J_ItemSum number" id="price0">￥<?php echo $data['price']; ?></em>
										</div>
									</li>
									<li class="td td-op">
										<div class="td-inner">
											<a  onclick="collection();">移入收藏</a><a onclick="del(0);">删除</a>
										</div>
									</li>
								</ul>
							</div>
				...
				<div class="float-bar-wrapper">
					...
					<div class="float-bar-right">
						...
						<div class="price-sum">
							...
							<strong class="price">¥<em id="totalPrice">0.00<span></span></em></strong>
						</div>
						<div class="btn-area">
							<a href="<?php echo url('index/index/pay'); ?>" id="J_Go" class="submit-btn submit-btn-disabled" aria-label="请注意如果没有选择宝贝，将无法结算">
								<span>结&nbsp;算</span></a>
						</div>
					</div>
				...
				<div class="theme-popbod dform">
					<form class="theme-signin" name="loginform" action="" method="post">
						...
						<div class="theme-signin-right">
							...
							<div class="text-info">
								<span class="J_Price price-now" id="price0"> ￥<?php echo $data['price']; ?></span>
