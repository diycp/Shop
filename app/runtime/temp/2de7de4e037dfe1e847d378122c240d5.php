<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\wamp64\www\app\public/../application/index\view\login\login.html";i:1525489612;}*/ ?>
﻿<!DOCTYPE html>
<html>
		...
		<div class="login-banner">
			<div class="login-main">
				...
				<div class="login-box">
                 ...
                 <div class="user-pass">
								    <label for="password"><i class="am-icon-lock"></i></label>
								    <input type="text" name="verify"  placeholder="验证码" style="width:150px">
            ...
            <div class="login-links">
                <label for="remember-me"><input id="remember-me" type="checkbox">记住密码</label>
								...
								<a href="<?php echo url('index/login/register'); ?>" class="zcnext am-fr am-btn-default">注册</a>
								<br />
            </div>
								<div class="am-cf">
