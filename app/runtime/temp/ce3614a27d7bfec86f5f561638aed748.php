<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"C:\wamp\www\app\public/../application/index\view\index\pay.html";i:1525534481;}*/ ?>
								   ...
								   <span class="province">湖北</span>省
									...
									<div id="holyshit269" class="submitOrder">
										<div class="go-btn-wrap">
											<a id="J_Go" href="<?php echo url('index/index/pay_yes'); ?>" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
										</div>
									</div>
									<div class="clear"></div>
								</div>
