<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\wamp\www\app\public/../application/index\view\index\sort.html";i:1526263969;}*/ ?>
﻿<!DOCTYPE html>
<html>
										...
										<?php if(is_array($tptc) || $tptc instanceof \think\Collection || $tptc instanceof \think\Paginator): $k = 0; $__LIST__ = $tptc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
											<li class="appliance js_toggle relative first selected">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/home/images/cake.png"></i><a class="ml-22" title="<?php echo $vo['name']; ?>"><?php echo $vo['name']; ?></a></h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															...
															<div class="brand-side">
																...
																<div class="sort-side">
																	<dl class="dl-sort">
																		<dd><a title="<?php echo $vs['name']; ?>"  href="<?php echo url('search',['id'=>$vs['gid']]); ?>"><span><?php echo $vs['name']; ?></span></a></dd>
																	</dl>
																</div>
