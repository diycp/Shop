<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"C:\wamp\www\app\public/../application/index\view\member\index.html";i:1525936194;}*/ ?>
﻿<!DOCTYPE html>
<html>
								...
								<div class="m-bg"></div>
					               <div class="m-userinfo">
									...
									<div class="m-baseinfo">
										...
										<em class="s-name"><?php echo \think\Session::get('name'); ?><span class="vip1"></em>
			...
			<aside class="menu">
				<ul>
					...
					<li class="person">
						<a href="#">我的资产</a>
						<ul>
							<li> <a href="<?php echo url('index/money/coupon'); ?>">优惠券 </a></li>
							<li> <a href="<?php echo url('index/money/bonus'); ?>">红包</a></li>
							<li> <a href="<?php echo url('index/money/bill'); ?>">账单明细</a></li>
						</ul>
					</li>
					...
					<li class="person">
						<a href="#">我的小窝</a>
						<ul>
							<li> <a href="<?php echo url('index/caveolae/collection'); ?>">收藏</a></li>
							<li> <a href="<?php echo url('index/caveolae/foot'); ?>">足迹</a></li>
							<li> <a href="<?php echo url('index/caveolae/comment'); ?>">评价</a></li>
							<li> <a href="<?php echo url('index/caveolae/news'); ?>">消息</a></li>
						</ul>
					</li>
