<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"C:\wamp\www\app\public/../application/index\view\index\info.html";i:1526199755;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<!--引导-->
		<div class="navCir">
			<li class="active"><a href="<?php echo url('index/member/index'); ?>l"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="<?php echo url('index/member/sort'); ?>"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="<?php echo url('index/member/shopcart'); ?>"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
